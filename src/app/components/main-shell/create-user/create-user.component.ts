...
export class CreateUserComponent implements OnInit {
  ...
  get name() {
    return this.formArray.get([0]).get('name');
  }
  get surname() {
    return this.formArray.get([0]).get('surname');
  }
  get username() {
    return this.formArray.get([0]).get('username');
  }
  get email() {
    return this.formArray.get([0]).get('email');
  }
  get phone() {
    return this.formArray.get([0]).get('phone');
  }
  get password() {
    return this.formArray.get([0]).get('password');
  }
  get confirmPassword() {
    return this.formArray.get([0]).get('confirmPassword');
  }
  get addressType() {
    return this.formArray.get([1]).get('addressType');
  }
  get address() {
    return this.formArray.get([1]).get('address');
  }
  get city() {
    return this.formArray.get([1]).get('city');
  }
  get postalCode() {
    return this.formArray.get([1]).get('postalCode');
  }
